...
var _getImagesApiJs = require("./get-images-api.js");
...
(0, _getImagesApiJs.getImages)().then((images)=>{
    renderImages(images);
});
galleryButtonEl.addEventListener("click", ()=>{
    (0, _getImagesApiJs.getImages)(currentPage).then((images)=>{
        renderImages(images);
        currentPage += 1;
    });
});

},{"./get-images-api.js":"grTsV"}],"grTsV":[function(require,module,exports,__globalThis) {
